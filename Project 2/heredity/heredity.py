...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people: 
        ...
        if mother is None and father is None:
            ...
            mother_prob = inheritance(mother, one_gene, two_genes)
            father_prob = inheritance(father, one_gene, two_genes)
            if genes == 2: 
...
def inheritance(parent_name, one_gene, two_gene):
    if parent_name in two_gene:
